...
static filesystem testfs1 = create_test_fs("testfs1", fs1);
static filesystem testfs2 = create_test_fs("testfs2", fs2);
static filesystem testfs3 = create_test_fs("testfs3", fs3);
