...
static void dp_show_opts(void)
{
   ...
   DUMP_INT_OPT(KRN_TIMER_HZ);
   DUMP_INT_OPT(KERNEL_STACK_PAGES);
   DUMP_INT_OPT(KRN_USER_STACK_PAGES);
   ...
   DUMP_INT_OPT(KRN_FBCON_BIGFONT_THR);
   DUMP_BOOL_OPT(KRN_FB_CONSOLE_BANNER);
   DUMP_BOOL_OPT(KRN_FB_CONSOLE_CURSOR_BLINK);
   DUMP_BOOL_OPT(KRN_FB_CONSOLE_USE_ALT_FONTS);
   DUMP_BOOL_OPT(KRN_SHOW_LOGO);
   DUMP_BOOL_OPT(KRN_PCI_VENDORS_LIST);
   ...
   DUMP_BOOL_OPT(KRN_STACK_ISOLATION);
   DUMP_BOOL_OPT(KRN_SYMBOLS);
   ...
   DUMP_BOOL_OPT(KRN_KMALLOC_HEAVY_STATS);
   DUMP_BOOL_OPT(KRN_KMALLOC_FREE_MEM_POISONING);
   DUMP_BOOL_OPT(KRN_KMALLOC_SUPPORT_DEBUG_LOG);
   DUMP_BOOL_OPT(KRN_KMALLOC_SUPPORT_LEAK_DETECTOR);
   DUMP_BOOL_OPT(BOOTLOADER_POISON_MEMORY);
   DUMP_BOOL_OPT(KRN_FB_CONSOLE_FAILSAFE_OPT);
