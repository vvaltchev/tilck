...
DEF_STATIC_CONF_RO(BOOL,  stack_isolation,         KRN_STACK_ISOLATION);
DEF_STATIC_CONF_RO(BOOL,  symbols,                 KRN_SYMBOLS);
...
DEF_STATIC_CONF_RO(BOOL,  big_io_buf,              KRN_BIG_IO_BUF);
