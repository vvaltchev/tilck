...
#ifndef CLANGD
  /*
   * HACK: include directly <ia32intrin.h> because <x86intrin.h> includes too
   * much stuff like FPU-related funcs which don't compile on x86_64 because
   * we have disabled FPU instructions.
   */
