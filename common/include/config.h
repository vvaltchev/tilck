...
#define KERNEL_LINEAR_MAPPING_MB   (256)
#define KERNEL_LINEAR_MAPPING_SIZE (KERNEL_LINEAR_MAPPING_MB << 20)
#define KERNEL_LINEAR_MAPPING_OVER_END \
   (KERNEL_BASE_VA + KERNEL_LINEAR_MAPPING_SIZE)
